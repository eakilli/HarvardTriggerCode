...
def getRate(triggers):
    ...
    for trigger in triggers + ['Total']:
        ...
        dataScaled[trigger][0] = ratesScaledJets[trigger][0]*\
                                ((datarate8TeV[trigger][0]-ratesW8TeV[trigger][0]-ratesZ8TeV[trigger][0]-ratesttbar8TeV[trigger][0]) if (datarate8TeV[trigger][0]-ratesW8TeV[trigger][0]-ratesZ8TeV[trigger][0]-ratesttbar8TeV[trigger][0])>0. else 0.)+\
    ...
    rate_mc = (Jets_14TeV[trigger][0] if Jets_14TeV[trigger][0]>0. else 0.)*1000+ratesW14TeV[trigger][0]*1000+ratesZ14TeV[trigger][0]*1000+ratesttbar14TeV[trigger][0]*1000
    
    rate_mcu = (Jets_14TeV[trigger][2] if Jets_14TeV[trigger][2]>0. else 0.)*1000+ratesW14TeV[trigger][2]*1000+ratesZ14TeV[trigger][2]*1000+ratesttbar14TeV[trigger][2]*1000
    
    rate_data = dataScaled[trigger][0]*1000
    
    rate_datau =dataScaled[trigger][2]*1000
    return (rate_data,rate_datau,rate_mc,rate_mcu)
